...
export default function SouthLuangwaPage() {
  ...
  const faqs = [
    ...
    { question: "What makes South Luangwa special for couples?", answer: "South Luangwa is the birthplace of the walking safari, offering couples an intimacy with the African wilderness that no vehicle based safari can match. With a maximum of 6 to 12 suites per camp and vast private concessions, you often have the bush entirely to yourselves. The combination of expert guides, exceptional wildlife concentrations, and ultra luxury camps creates a safari experience that is both thrilling and deeply romantic." },
    ...
    { question: "How do I get to South Luangwa?", answer: "International visitors fly into Kenneth Kaunda International Airport in Lusaka (LUN) via Johannesburg, Nairobi, or Addis Ababa. From Lusaka, it's a 1.5 hour light aircraft flight to Mfuwe Airport (MFU), followed by a 30 to 60 minute game drive transfer to your camp, your safari begins before you arrive. Kivara arranges all internal flights and transfers for a seamless journey." },
  ...
  return (
    <>
      ...
      <BreadcrumbJsonLd
        items={[
          { name: "Home", url: "/" },
          { name: "South Luangwa", url: "/south-luangwa" },
        ]}
      />
      {/* Hero Section */}
