/**
 * Kivara custom icon set — refined SVG icons matching the brand aesthetic.
 * Thin strokes, elegant proportions. Gold/earth compatible.
 */
...
export function QuoteIcon({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M3 21c3-3 5-6 5-9V6H4v6h2c0 3-1 5-3 7v2z" />
      <path d="M15 21c3-3 5-6 5-9V6h-4v6h2c0 3-1 5-3 7v2z" />
    </svg>
  );
}
