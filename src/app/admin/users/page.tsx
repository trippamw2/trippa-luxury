    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-earth mt-1">Manage admins, editors, and agents.</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          { label: "Total Users", value: "5", color: "text-soft-black" },
      ...
      <div className="bg-white border border-sand-light overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b border-sand-light">
            <tr>
              <th className="text-left px-5 py-3 font-medium text-earth text-xs uppercase tracking-wider">Name</th>
              <th className="text-left px-5 py-3 font-medium text-earth text-xs uppercase tracking-wider">Email</th>
              ...
              >
                <td className="px-5 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-soft-black">{user.name}</span>
                  </div>
                </td>
                <td className="px-5 py-4 text-earth">{user.email}</td>
                <td className="px-5 py-4">
