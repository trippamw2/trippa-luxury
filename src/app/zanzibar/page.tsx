  ...
  return (
    <>
      ...
      <section className="relative h-screen w-full overflow-hidden bg-soft-black">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] rounded-full opacity-[0.06] pointer-events-none" aria-hidden="true"
