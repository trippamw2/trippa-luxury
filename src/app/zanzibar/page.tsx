    ...
    <>
      ...
      <section className="py-24 md:py-32 bg-soft-black">
        <Container>
          ...
          >
            <MapEmbed
              lat={DESTINATION_COORDINATES["zanzibar"].lat}
              lng={DESTINATION_COORDINATES["zanzibar"].lng}
              zoom={DESTINATION_COORDINATES["zanzibar"].zoom}
              title="Map of Zanzibar properties"
              className="h-full"
            />
          </motion.div>
        </Container>
