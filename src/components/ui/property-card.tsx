        ...
        <div className="bezel-outer">
          <div className="bezel-inner aspect-[4/5]">
            ...
            <div className="absolute inset-0 bg-soft-black/0 group-hover:bg-soft-black/25 transition-all duration-700 flex items-center justify-center">
              <span className="opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0 text-cream text-sm tracking-widest uppercase border border-cream/60 backdrop-blur-[2px] px-7 py-3 rounded-full">
                Explore Property
              </span>
            </div>
