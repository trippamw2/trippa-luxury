...
export default function LakeMalawiPage() {
  ...
  const faqs = [
    ...
    { question: "How many days should we spend on Lake Malawi?", answer: "We recommend 5 to 7 nights at a single property to fully immerse in the Lake Malawi rhythm, or 7 to 10 nights to combine two lodges (e.g., Kaya Mawa on Likoma Island followed by Pumulani on the mainland shore). Most couples find that a week allows the perfect balance of adventure, relaxation, and romance." },
  ];
