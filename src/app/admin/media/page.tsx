    ...
    <div className="space-y-6">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-soft-black/50 flex items-center justify-center z-40 p-4" onClick={() => setShowModal(false)}>
          <div className="bg-cream border border-sand-light w-full max-w-md max-h-[90vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4 min-h-0">
              {formData.url && (
                <div className="relative aspect-video bg-sand-light overflow-hidden">
