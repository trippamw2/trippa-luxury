    ...
    rooms: [
      {
        ...
        images: [
          { label: "Bedroom", path: "/images/kaya-mawa-std-rooms-khuyu.webp" },
          { label: "View", path: "/images/kaya-mawa-std-rooms-msekwa.webp" },
          { label: "Interior", path: "/images/kaya-mawa-std-rooms-makungulu.webp" },
      ...
      },
      {
        ...
        images: [
          ...
          { label: "Bath", path: "/images/kaya-mawa-mbamba-room-view.jpg" },
        ],
        sleeps: 3,
      },
      {
