    ...
    <>
      ...
      <section className="py-24 md:py-32 bg-soft-black">
        <Container>
          ...
          >
            <MapEmbed
              lat={DESTINATION_COORDINATES["lake-malawi"].lat}
              lng={DESTINATION_COORDINATES["lake-malawi"].lng}
              zoom={DESTINATION_COORDINATES["lake-malawi"].zoom}
              title="Map of Lake Malawi properties"
              className="h-full"
            />
          </motion.div>
        </Container>
