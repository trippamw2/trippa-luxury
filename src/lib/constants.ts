...
export const PROPERTIES = [
  {
    ...
    priceRange: "$430 to $860 per person per night",
    ...
    amenities: [
      ...
      "Spa treatments",
      "100% solar powered (Green Safaris)",
      "Helicopter pad",
      "Complimentary WiFi",
    ],
    rating: 4.9,
  ...
  },
  {
    ...
    priceRange: "$1,510 to $1,995 per person per night (park fees additional $120pppn)",
  ...
  },
  {
    ...
    priceRange: "$500 to $1,400 per night (all-inclusive)",
...
export const PACKAGES = [
  {
    ...
    inclusions: [
      ...
      "All meals at Kaya Mawa (breakfast, lunch, dinner)",
      "House wines, spirits and soft drinks at Kaya Mawa",
      "All activities at Kaya Mawa (kayaking, snorkelling, sailing, paddleboarding)",
      "Chinzombo full board: all meals, house drinks, game drives, walking safaris",
      "Airport and lodge transfers",
      "Domestic charter flights (Likoma → Mfuwe)",
      "Private sunset dhow cruise",
      "Couples spa treatment",
      "Bush breakfast and bush dinner",
      "South Luangwa park fees ($120pppn)",
    ...
    excludes: [
      ...
      "Visa fees",
      "Travel insurance",
      "Premium beverages at Chinzombo",
      "Personal expenses",
      "Gratuities",
    ],
    itinerary: [
  ...
  },
  {
    ...
    inclusions: [
      ...
      "All activities at Kaya Mawa (kayaking, snorkelling, sailing, paddleboarding)",
      "Chinzombo full board: all meals, house drinks, game drives, walking safaris",
      "Xanadu all-inclusive: all meals, premium beverages, butler service, activities",
      "Airport and lodge transfers",
      "Domestic charter flights between destinations",
      "Private sunset dhow cruise",
      "Couples spa treatment",
  ...
  },
  {
    ...
    inclusions: [
      "Luxury accommodation at Chinzombo",
  ...
  },
  {
    ...
    inclusions: [
      "Luxury accommodation at Pumulani Lodge",
      "Fully Inclusive Plus: all meals and select premium drinks",
      "Lake activities (kayaking, sailing, snorkelling, waterskiing, wakeboarding)",
      "Guided nature walks and village visits",
      "Private sunset dhow cruise",
      "Couples spa treatment",
  ...
  },
  {
    ...
    inclusions: [
      "Xanadu all-inclusive: all meals, premium beverages, butler service, activities",
      "Baraza all-inclusive: all meals, premium beverages, activities",
      "Private plunge pool at each villa",
      "Kiota Spa couples treatment at Xanadu",
      "Frangipani Spa couples ritual at Baraza",
      "Sunset dhow cruise on Free Spirit",
      "Stone Town heritage walk",
      "Spice plantation visit",
    ...
    itinerary: [
      { day: 1, title: "Arrival in Zanzibar", description: "Transfer to Xanadu Luxury Villas & Retreat. Settle into your private villa with plunge pool and personal butler." },
      { day: 2, title: "Villa Life", description: "A day entirely at leisure : beach, pool, Kiota Spa treatments, and the Indian Ocean as your horizon." },
      ...
      { day: 5, title: "Ocean Romance", description: "Sunset dhow cruise along the coast, followed by a couples spa ritual at Frangipani Spa." },
  ...
  },
  {
    ...
    inclusions: [
      "Luxury accommodation at Makokola and Chinzombo",
      "Surprise room décor and champagne",
      "Private romantic dinner at Il Lago",
      "Sunset cruise along the southern shore",
      "Couples spa treatment",
      "Chinzombo full board: all meals, house drinks, game drives, walking safaris",
      "Bush dinner beneath the stars",
      "Airport transfers",
      "Domestic charter flights (Makokola → Mfuwe)",
      "South Luangwa park fees ($120pppn)",
      "Dedicated Kivara Journey Concierge",
    ],
    excludes: [
  ...
  },
  {
    ...
    inclusions: [
      "Luxury accommodation at Puku Ridge and Baraza",
      "Puku Ridge: meals, beverages, guided game drives day + night, walking safaris",
      "Star bed experience at Puku Ridge",
      "Baraza all-inclusive: all meals, premium beverages, activities",
      "Couples spa treatment at Baraza Frangipani Spa",
      "Sunset dhow cruise along the Bwejuu coast",
      "Stone Town heritage walk",
      "South Luangwa park fees ($120pppn)",
      "Airport transfers",
      "Domestic charter flights (Mfuwe → Zanzibar)",
      "Dedicated Kivara Journey Concierge",
    ],
    excludes: [
      "International flights",
  ...
  },
  {
    ...
    properties: ["kaya-mawa", "chinzombo", "xanadu-villas"],
    inclusions: [
      "Luxury accommodation at Kaya Mawa, Chinzombo, and Xanadu",
      "Kaya Mawa: all meals, house wines/spirits, all activities included",
      "Chinzombo: full board, house drinks, game drives, walking safaris",
      "Xanadu: all-inclusive meals, premium beverages, butler, activities",
      "All private transfers and domestic charter flights",
  ...
  },
  {
    ...
    inclusions: [
      "Fully customised itinerary composed around your vision",
      "Luxury accommodation at curated properties",
      "Meals as per property inclusions (varies by property)",
      "All private transfers and domestic charter flights",
      "Private experiences composed around your wishes",
      "South Luangwa park fees where applicable ($120pppn)",
      "Dedicated Kivara Journey Concierge",
    ],
    excludes: [
      "International flights",
      "Visa fees",
      "Travel insurance",
      "Premium beverages (where not included by property)",
      "Personal expenses",
      "Gratuities",
    ],
    itinerary: [
...
export const EXPERIENCES = [
  {
    ...
    description: "An intimate dinner beneath the stars with your toes in the sand. A table for two, candlelight, and the rhythm of waves as your soundtrack. Available at Kaya Mawa on Likoma Island and Pumulani on the Nankumba Peninsula.",
    image: IMAGES.dining,
    category: "Romance",
    destination: "lake-malawi",
    coordinates: { lat: -12.059, lng: 34.734 },
  ...
  },
  {
    ...
    description: "Sail into the golden hour on a traditional dhow across Lake Malawi or the Zanzibar coast. Champagne in hand, the sky painted in amber and rose. Xanadu's dhow 'Free Spirit' and Baraza's coastal cruises offer two distinct experiences.",
    image: IMAGES.dhow,
    category: "Romance",
    destination: "zanzibar",
    coordinates: { lat: -6.15, lng: 39.483 },
  ...
  },
  {
    ...
    description: "Sleep beneath a canopy of African stars on a raised platform in the wilderness. Puku Ridge Camp's iconic star bed towers above each suite, offering an unobstructed view of the Milky Way over the Kakumbi Floodplain.",
  ...
  },
  {
    id: "bush-dining",
    title: "Bush Dining",
    description: "A table set in the wilderness, surrounded by lanterns and the sounds of the African night. Chinzombo's riverfront fire pit dining and Puku Ridge's floodplain dinners offer fine dining where raw nature is the backdrop.",
  ...
  },
  {
    ...
    description: "Explore underwater worlds at two of Africa's finest dive destinations. Kaya Mawa's PADI dive centre on Likoma Island reveals the freshwater cichlid reefs of Lake Malawi, while Baraza's PADI centre on Bwejuu Beach accesses the Indian Ocean's coral gardens.",
    image: IMAGES.lakeMalawiAerial,
    category: "Adventure",
    destination: "lake-malawi",
    coordinates: { lat: -12.059, lng: 34.734 },
  },
  {
    id: "spice-plantation",
    title: "Spice Plantation & Stone Town",
    description: "Wander through Zanzibar's aromatic heart — clove, cinnamon, vanilla, and cardamom perfume the air. Combine with a heritage walk through Stone Town's ancient corridors, a UNESCO World Heritage Site.",
    image: IMAGES.zanzibarStoneTown,
    category: "Cultural",
    destination: "zanzibar",
  ...
  {
    id: "water-sports",
    title: "Lake & Ocean Water Sports",
    description: "From Pumulani's water skiing and wakeboarding on Lake Malawi to Baraza's kite surfing and Xanadu's sea kayaking on the Indian Ocean — Africa's waters offer something for every pace, from adrenaline to stillness.",
    image: IMAGES.lakeMalawiSunset,
    category: "Adventure",
    destination: "lake-malawi",
    coordinates: { lat: -14.013, lng: 34.832 },
  },
