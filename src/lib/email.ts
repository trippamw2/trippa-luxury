    ...
    htmlContent: `
      <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #FAF7F2; color: #1A1A1A;">
        <div style="background: #1A1A1A; padding: 32px 40px; text-align: center;">
          <h1 style="font-family: 'Trajan Pro', 'Times New Roman', serif; color: #D4BC8A; font-size: 24px; margin: 0; letter-spacing: 2px;">Kivara</h1>
        ...
        <div style="padding: 40px;">
          <h2 style="font-family: 'Trajan Pro', 'Times New Roman', serif; font-size: 20px; color: #1A1A1A; margin: 0 0 24px;">A new traveler has reached out</h2>
        ...
        <div style="background: #EDE5DA; padding: 20px 40px; text-align: center;">
          <p style="font-size: 11px; color: #8B7D6B; margin: 0;">Kivara Luxury Travel — Curating Africa's Finest Romance Escapes</p>
        </div>
      </div>
    `,
  };
...
export function inquiryConfirmationEmail(data: {
  ...
  return {
    subject: "Thank You — Your Kivara Inquiry Has Been Received",
    htmlContent: `
      <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #FAF7F2; color: #1A1A1A;">
        <div style="background: #1A1A1A; padding: 32px 40px; text-align: center;">
          <h1 style="font-family: 'Trajan Pro', 'Times New Roman', serif; color: #D4BC8A; font-size: 24px; margin: 0; letter-spacing: 2px;">Kivara</h1>
        ...
        <div style="padding: 40px;">
          <h2 style="font-family: 'Trajan Pro', 'Times New Roman', serif; font-size: 20px; color: #1A1A1A; margin: 0 0 16px;">Dear ${data.fullName},</h2>
          <p style="font-size: 14px; color: #4A4A4A; line-height: 1.7; margin: 0 0 16px;">Thank you for reaching out to Kivara. Your inquiry has been received with care, and our concierge team is already reviewing the details to craft the perfect escape for you.</p>
          ...
          <p style="font-size: 14px; color: #4A4A4A; line-height: 1.7; margin: 0;">Warmest regards,<br><strong style="color: #C9A96E;">The Kivara Concierge Team</strong></p>
        </div>
        <div style="background: #EDE5DA; padding: 20px 40px; text-align: center;">
          <p style="font-size: 11px; color: #8B7D6B; margin: 0;">Kivara Luxury Travel — Curating Africa's Finest Romance Escapes</p>
        </div>
  ...
  return {
    ...
    htmlContent: `
      <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #FAF7F2; color: #1A1A1A;">
        ...
        <div style="padding: 40px;">
          <h2 style="font-family: 'Trajan Pro', 'Times New Roman', serif; font-size: 20px; color: #1A1A1A; margin: 0 0 8px;">New Booking: ${data.bookingRef}</h2>
        ...
        <div style="background: #EDE5DA; padding: 20px 40px; text-align: center;">
          <p style="font-size: 11px; color: #8B7D6B; margin: 0;">Kivara Luxury Travel</p>
        </div>
      </div>
    `,
  };
...
export function newsletterWelcomeEmail() {
  return {
    subject: "Welcome to Kivara — Africa's Finest Romance Escapes",
    htmlContent: `
      <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #FAF7F2; color: #1A1A1A;">
        <div style="background: #1A1A1A; padding: 32px 40px; text-align: center;">
          <h1 style="font-family: 'Trajan Pro', 'Times New Roman', serif; color: #D4BC8A; font-size: 24px; margin: 0; letter-spacing: 2px;">Kivara</h1>
        ...
        <div style="padding: 40px;">
          <h2 style="font-family: 'Trajan Pro', 'Times New Roman', serif; font-size: 20px; color: #1A1A1A; margin: 0 0 16px;">Welcome to Kivara</h2>
          ...
          <p style="font-size: 14px; color: #4A4A4A; line-height: 1.7; margin: 0;">Warmest regards,<br><strong style="color: #C9A96E;">The Kivara Team</strong></p>
        </div>
        <div style="background: #EDE5DA; padding: 20px 40px; text-align: center;">
          <p style="font-size: 11px; color: #8B7D6B; margin: 0;">Kivara Luxury Travel</p>
        </div>
...
export function paymentReceiptEmail(data: {
  ...
  return {
    subject: `Payment Receipt — ${data.bookingRef} — Kivara`,
    htmlContent: `
      <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #FAF7F2; color: #1A1A1A;">
        <div style="background: #1A1A1A; padding: 32px 40px; text-align: center;">
          <h1 style="font-family: 'Trajan Pro', 'Times New Roman', serif; color: #D4BC8A; font-size: 24px; margin: 0; letter-spacing: 2px;">Kivara</h1>
        ...
        <div style="padding: 40px;">
          <h2 style="font-family: 'Trajan Pro', 'Times New Roman', serif; font-size: 20px; color: #1A1A1A; margin: 0 0 16px;">Thank you, ${data.clientName}</h2>
